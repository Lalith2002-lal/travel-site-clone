...
function updateFileInputLabelOnEdit() {
  ...
  // Reset the image preview when no file is chosen
...
function resetFormState() {
  ...
  if (imagePreviewElement) {
    imagePreviewElement.src = ""; // Set the src attribute to an empty string
    imagePreviewElement.style.display = "none"; // Hiding the image
  }
  ...
  // Reset image preview and file input label for editing
  updateFileInputLabelOnEdit();
